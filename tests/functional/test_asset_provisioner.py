...
def default_host_params():
    params = dict(
        ...
        provider=dict(name="openstack", credential="openstack"),
    )
    return params
...
def default_no_provider_host_params():
    params = dict(description="description", provisioner="openstack-libcloud")
    return params
...
@pytest.fixture(scope="class")
def plugin():
    pg = mock.MagicMock(spec=ProvisionerPlugin, __plugin_name__="openstack-libcloud")
...
def host(plugin, default_host_params):
    host = mock.MagicMock(
        spec=Asset,
        name="Test-Asset",
        provider_params=dict(param1="value1"),
...
class TestAssetProvisioner(object):
    ...
    def test_asset_provisioner_create_multi_resources(
        mock_copy, plugin, host_provisioner, default_profile_params
    ):
    ...
    @staticmethod
    @mock.patch("copy.deepcopy")
    def test_asset_provisioner_create_multi_resources_no_provider(
        mock_copy, plugin, host_provisioner, default_no_provider_profile_params
    ):
    ...
    @staticmethod
    @mock.patch("copy.deepcopy")
    def test_asset_provisioner_create_single_resource(
        mock_copy, plugin, host_provisioner, default_profile_params
    ):
        mock_copy.return_value = default_profile_params
    ...
    @staticmethod
    @mock.patch("copy.deepcopy")
    def test_asset_provisioner_create_single_resource_no_provider(
        mock_copy, plugin, host_provisioner, default_no_provider_profile_params
    ):
        mock_copy.return_value = default_no_provider_profile_params
        res1 = dict(tx_id=1, hostname="dummy_0", ip="2.4.6.8", asset_id="222")
    ...
    def test_asset_provisioner_print_common_attributes(
        mock_logger, plugin, host_provisioner
    ):
