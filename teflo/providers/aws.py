...
class AwsProvider(TefloProvider):
    ...
    def __init__(self):
        ...
        self._supported_roles = [
            self.__provider_name__ + "_" + suffix
            for suffix in [
                "ec2",
                "sg",
                "s3",
        ...
        self.req_sg_params = [("description", [str]), ("rules", [list])]

        self.opt_sg_params = [("region", [str]), ("vpc_id", [str])]
        ...
        self.req_ec2_eip_params = [("region", [str])]
        ...
        self.req_ec2_vpc_nat_gateway_params = [("region", [str]), ("vpc_id", [str])]
        ...
        for item in self.req_params:
            ...
            try:
                ...
                if param_value and param_value in self._supported_roles:
                    getattr(self, "validate_req_%s_params" % param_value[4:])(
    ...
    def validate_opt_params(self, resource):
        ...
        for item in self.req_params:
            ...
            try:
                ...
                param_value = provider_params[param]
                if param_value and param_value in self._supported_roles:
                    getattr(self, "validate_opt_%s_params" % param_value[4:])(
                        provider_params, name
                    )
                    break
