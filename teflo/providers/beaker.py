...
class BeakerProvider(PhysicalProvider):
    ...
    def __init__(self):
        ...
        self.req_params = [("name", [str]), ("arch", [str]), ("variant", [str])]
        ...
        self.req_credential_params = [("hub_url", [str])]
    ...
    def validate_opt_teflo_params(self, resource_name, provisioner_name, params):
        ...
        if "linchpin" not in provisioner_name:
            ...
            for item in self.teflo_only_opt_params:
                ...
                msg = (
                    "Resource %s : optional param '%s' is "
                    "not support by the linchpin-wrapper provisioner"
                    % (resource_name, param)
                )
                try:
                    if params[param]:
